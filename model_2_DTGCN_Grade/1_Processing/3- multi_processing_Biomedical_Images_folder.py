...
parser.add_argument('--folder_path', type=str, required=True,
                    default='/Users/*****MYUSERNAME****/Documents/GitHub/3DVNN_202400801/BIOMEDIC_PROJECT/dataset/dataverse_files-2/Combined/Combined_images/',
                    help='The folder Path to the folder containing images')
parser.add_argument('--output_folder_tri', type=str, required=True,
                    default='/Users/*****MYUSERNAME****/Documents/GitHub/3DVNN_202400801/BIOMEDIC_PROJECT/dataset/dataverse_files-2/Combined/Dataset_512/Triangulations/',
                    help='Destination folder for triangulations')
parser.add_argument('--output_folder_label', type=str, required=True, 
                    default='/Users/*****MYUSERNAME****/Documents/GitHub/3DVNN_202400801/BIOMEDIC_PROJECT/dataset/dataverse_files-2/Combined/Dataset_512/Label Matrices/',
