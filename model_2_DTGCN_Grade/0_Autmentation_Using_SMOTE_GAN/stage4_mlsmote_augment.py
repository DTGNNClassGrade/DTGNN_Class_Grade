...
X = np.load("/Users/*****MYUSERNAME****/Documents/GitHub/3DVNN_202400801/BIOMEDIC_PROJECT/dataset/dataverse_files-2/Combined/underrepresented_Images/BlueRedWhite/X_features.npy")  # Shape: (N, 512)
print(f"X shape: {X.shape}")
Y = np.load("/Users/*****MYUSERNAME****/Documents/GitHub/3DVNN_202400801/BIOMEDIC_PROJECT/dataset/dataverse_files-2/Combined/underrepresented_Images/BlueRedWhite/Y_labels.npy")    # Shape: (N, 5)
...
np.save("/Users/*****MYUSERNAME****/Documents/GitHub/3DVNN_202400801/BIOMEDIC_PROJECT/dataset/dataverse_files-2/Combined/underrepresented_Images/BlueRedWhite/X_augmented.npy", X_aug)
np.save("/Users/*****MYUSERNAME****/Documents/GitHub/3DVNN_202400801/BIOMEDIC_PROJECT/dataset/dataverse_files-2/Combined/underrepresented_Images/BlueRedWhite/Y_augmented.npy", Y_aug)
