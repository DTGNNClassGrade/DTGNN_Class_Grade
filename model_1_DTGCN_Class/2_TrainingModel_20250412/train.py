...
def main():
    ...
    for i, model in enumerate(models):
        model_path = f"/Users/*****MYUSERNAME****/Documents/GitHub/3DVNN_202400801/BIOMEDIC_PROJECT/model_1_DTGCN_Class/2_TrainingModel_20250412/saved_model_checkpoints/model_fold_{i+1}.pt"
        torch.save(model.state_dict(), model_path)
        print(f"💾 Saved model for Fold {i+1} at {model_path}")
    #save the arguments
    args_path = "/Users/*****MYUSERNAME****/Documents/GitHub/3DVNN_202400801/BIOMEDIC_PROJECT/model_1_DTGCN_Class/2_TrainingModel_20250412/saved_model_checkpoints/args.txt"
    with open(args_path, 'w') as f:
        for arg in vars(args):
            f.write(f"{arg}: {getattr(args, arg)}\n")
    print(f"💾 Saved arguments at {args_path}")
    #save the fold metrics
    fold_metrics_path = "/Users/*****MYUSERNAME****/Documents/GitHub/3DVNN_202400801/BIOMEDIC_PROJECT/model_1_DTGCN_Class/2_TrainingModel_20250412/saved_model_checkpoints/fold_metrics.txt"
